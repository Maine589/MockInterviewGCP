    ...
    <div className="flex flex-col items-center h-full animate-fade-in">
      ...
      <div className="w-full max-w-3xl bg-gray-900/50 rounded-lg p-6">
        <div className="flex items-center gap-6 mb-6 pb-6 border-b border-gray-700">
            ...
            <div className="flex-1">
                <h3 className="text-xl font-semibold text-gray-200 mb-2">Interviewer Performance Review</h3>
        ...
        <div className="prose prose-invert prose-p:text-gray-300 prose-headings:text-gray-100 max-w-none text-left">
      ...
      <div className="w-full max-w-3xl mt-6">
        <details className="bg-gray-900/50 rounded-lg p-4 cursor-pointer">
            <summary className="font-semibold text-gray-200">View Full Transcript</summary>
            <pre className="mt-4 text-sm text-gray-400 whitespace-pre-wrap max-h-60 overflow-y-auto p-2 bg-gray-900 rounded">{transcript}</pre>
        </details>
      </div>

      <button
        onClick={onReset}
        className="mt-8 px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-500 transition-all focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-900"
      >
        Start New Interview
      </button>
    </div>
